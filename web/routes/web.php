...
Route::get('/api/auth/callback', function (Request $request) {
    ...
    if ($response->isSuccess()) {
        Log::debug("Ashish  Agrawal Registered APP_UNINSTALLED webhook for shop $shop");
    } else {
        Log::error(
...
Route::post('/api/webhooks', function (Request $request) {
    ...
    try {
		...
		Log::debug("Ashish webhook $topic");
...
Route::post('/api/add-design', [SettingController::class, 'create']);
Route::post('api/editdesign/{id}', [SettingController::class, 'edit']);
Route::get('api/viewdesign/{id}', [SettingController::class, 'show']);
Route::post('api/remove-design/{id}', [SettingController::class, 'destroy']);
Route::post('api/remove-print/{id}', [SettingController::class, 'printdestroy']);
...
Route::get('api/getdmsettings', [SettingController::class, 'apigetsettings']);
